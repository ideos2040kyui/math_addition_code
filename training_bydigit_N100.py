...
import wandb
wandb.init(project="Addition_training_bydigit")
...
if __name__ == '__main__':
    ...
    GPT2_Module.model.save_pretrained("models/GPT2_addition_model_bydigit_N100")

    GPT2_Module.model = AutoModelForCausalLM.from_pretrained("models/GPT2_addition_model_bydigit_N100")
